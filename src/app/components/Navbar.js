          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div className="hidden sm:ml-6 sm:block">
              <div className="flex space-x-4">
                    <Link href="/" className="text-white hover:bg-blue-900 hover:text-white font-bold rounded-md px-3 py-2 text-sm font-medium"> Flights </Link>
                    <Link href="/hotels" className="text-white hover:bg-blue-900 hover:text-white font-bold rounded-md px-3 py-2 text-sm font-medium"> Hotels </Link>
                    <Link href="/car-rental" className="text-white hover:bg-blue-900 hover:text-white font-bold rounded-md px-3 py-2 text-sm font-medium"> Car Rental </Link>
              </div>
            </div>
          </div>
